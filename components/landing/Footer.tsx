        ...
        <div className="flex justify-center gap-4 mt-12">
          {socials.map(({ svg, href, label }, i) => (
            <motion.a
              ...
              whileTap={{ scale: 0.93 }}
              aria-label={label}
              className="h-[52px] w-[52px] rounded-2xl border border-white/[0.08] bg-white/[0.03] flex items-center justify-center text-white/50 hover:text-white hover:border-cyan-400/25 hover:bg-cyan-500/[0.07] transition-all duration-300"
            >
              {svg}
            </motion.a>
          ))}
