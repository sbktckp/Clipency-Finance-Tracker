    ...
    <footer className="relative px-6 py-24 border-t border-white/[0.06] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.15, duration: 0.7 }} className="mt-8">
          <a href="/login">
            <motion.button whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }} className="px-8 py-3.5 rounded-2xl bg-gradient-to-r from-blue-500 to-purple-600 font-semibold text-sm shadow-[0_0_40px_rgba(99,102,241,0.3)] hover:shadow-[0_0_55px_rgba(99,102,241,0.5)] transition-shadow duration-300">
              Get Started →
            </motion.button>
          </a>
        </motion.div>
