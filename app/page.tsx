        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-8 text-lg text-white/70 leading-relaxed max-w-2xl">
              Clipency Finance OS is a centralized internal finance management
              platform built to track operational capital, campaign spending,
              payouts, salaries, marketing expenses, platform fees, and live
              financial flow across the company.
            </p>

            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                href="/login"
                className="px-7 py-4 rounded-2xl bg-gradient-to-r from-fuchsia-600 to-cyan-500 font-semibold hover:scale-105 transition-all duration-300 shadow-2xl"
              >
                Access Finance OS
              </Link>
            ...
            <div className="relative rounded-[32px] border border-white/10 bg-white/5 backdrop-blur-2xl p-8 shadow-2xl">
              <div className="grid grid-cols-2 gap-5">
                ...
                <div className="rounded-3xl bg-white/5 border border-white/10 p-6">
                  ...
                  <h3 className="text-4xl font-bold text-yellow-300 mt-3">
                    Protected
                  </h3>
                </div>
              </div>
              ...
              <div className="mt-8 rounded-3xl border border-fuchsia-500/20 bg-fuchsia-500/10 p-6">
                ...
                <p className="mt-4 text-white/60 leading-relaxed">
                  Campaign funds and operational funds remain separated to
                  maintain complete financial clarity and accountability.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-14">
            ...
            <p className="mt-4 text-white/60 text-lg">
              A complete internal finance infrastructure designed for scale,
